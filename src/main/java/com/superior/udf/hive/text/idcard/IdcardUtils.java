package com.superior.udf.hive.text.idcard;
...
/**
 * Created by melin on 2018/4/13 下午5:17
 */
public class IdcardUtils {
    ...
    public static Map<String, Object> parserIdCard(String idcard) {
        Map<String, Object> result = Maps.newHashMap();
        try {
            boolean valid = isValidatedAllIdcard(idcard);
            ...
            for (String id : key) {
                if (id.equals(provinceId)) {
                    String province = cityCodeMap.get(id);
            ...
            int age=Integer.parseInt(currentYear) - year;
            result.put("age", age);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) {
        Map<String, Object> map = parserIdCard("430304197802031322");
